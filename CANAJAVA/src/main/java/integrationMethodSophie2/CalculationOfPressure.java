...
public class CalculationOfPressure {
	...
	public static void main(String[] args) {
		...
		// System.out.println("With Euler Method: " +
		// IntegratingPressure.EulersMethod(r, rho, n) + " Pa");
		// System.out.println("With Simpsons Method: " +
		// IntegratingPressure.SimpsonsMethod(r, rho, n) + " Pa");
		// System.out.println("Exact Pressure: " + ExactPressure(r, rho) + " Pa");

		// System.out.println(
		// "Error of Euler Method: " + (1 - IntegratingPressure.EulersMethod(r, rho, n)
		// / ExactPressure(r, rho)));
		// System.out.println("Error of Simpsons Method: "
		// + (1 - IntegratingPressure.SimpsonsMethod(r, rho, n) / ExactPressure(r,
		// rho)));
	}
